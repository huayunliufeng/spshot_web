<template>
    ...
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 10px">
            ...
            <el-breadcrumb-item>不规范</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <div>
            <el-dialog center title="详情" :visible.sync="dialogFormVisible">
                ...
                <template>
                    <el-form label-position="left" :model="formData" style="height: 500px;overflow: scroll;">
                        ...
                        <el-form-item prop="reason">
                            <i class="icon-spshot-jujueliyouyemian"></i>&nbsp;&nbsp;拒绝理由
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" style="width: 100px" round @click="dialogFormVisible = false">取消
                    </el-button>
                    <el-button type="success" round @click="pass()">确认通过</el-button>
                </div>
            </el-dialog>
        ...
        methods: {
            ...
            handleCurrentChange(currentPage) {
                ...
                if (loginname.endsWith("_op")) {
                    postRequest("/issure/issure/search/-1/" + id, this.pagination).then((res) => {
                    ...
                    //否则查询所有投票
                    postRequest("/issure/issure/search/-1", this.pagination).then((res) => {
                        this.pagination.total = res.data.total;
                        this.tableData = res.data.rows;
                    }, (err) => {
                        this.$message.error("出错！");
