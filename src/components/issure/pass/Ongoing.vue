        ...
        <div>
            <el-dialog center title="详情" :visible.sync="dialogFormVisible" @close="close()">
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button type="danger" round @click="dialogVisible = true">封禁</el-button>
                    <el-button type="primary" round @click="dialogFormVisible = false">确认</el-button>
                </div>
            </el-dialog>

            <el-dialog title="封禁理由" :visible.sync="dialogVisible" center>
                <el-input style="font-size: 20px" type="textarea" v-model="reason"></el-input>
                <div slot="footer" class="dialog-footer">
                    <el-button @click="dialogVisible = false">取消</el-button>
                    <el-button type="danger" @click="banned()">确认</el-button>
                </div>
            </el-dialog>
        </div>
    </div>
...
<script>
    ...
    import {deleteRequest, getRequest, postRequest} from "../../../utils/api.js";
    ...
    export default {
        ...
        methods: {
            ...
            handleCurrentChange(currentPage) {
                ...
                postRequest("/issure/issure/pass/1/0", this.pagination).then((res) => {
            ...
            banned() {
                ...
                postRequest("/issure/issure/audit/2", this.verifyData).then((res) => {
